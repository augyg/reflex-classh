...
/* package ClasshSS-0.1.0.0 */
#ifndef VERSION_ClasshSS
#define VERSION_ClasshSS "0.1.0.0"
#endif /* VERSION_ClasshSS */
#ifndef MIN_VERSION_ClasshSS
#define MIN_VERSION_ClasshSS(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_ClasshSS */
...
#define CURRENT_PACKAGE_KEY "ClasshSS-0.1.0.0-inplace"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "ClasshSS-0.1.0.0-inplace"
